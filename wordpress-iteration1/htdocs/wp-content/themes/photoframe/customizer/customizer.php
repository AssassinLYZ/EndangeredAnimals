...
function photoframe_customize_register( $wp_customize ) {
    ...
    class Podcast_WP_Help_Customize_Control extends WP_Customize_Control {
        ...
        public function render_content() {
            $photoframe_ep_activated = '';
            if ( get_option( 'photoframe_ep_license_status' ) == 'valid' ) {
                $photoframe_ep_activated = 'bnt-customizer-ep-active';
            }
            echo '
                <div class="bnt-customizer-help">
                    <a class="bnt-customizer-link bnt-support-link" href="https://www.ilovewp.com/documentation/photoframe/" target="_blank">
                        <span class="dashicons dashicons-book">
                        </span>
                        '.esc_html__( 'Theme Documentation', 'photoframe' ).'
                    </a>
                    <a class="bnt-customizer-link bnt-support-link" href="https://www.ilovewp.com/themes/photoframe/" target="_blank">
                        <span class="dashicons dashicons-info">
                        </span>
                        '.esc_html__( 'Official Theme Page', 'photoframe' ).'
                    </a>
                    <a class="bnt-customizer-link bnt-support-link" href="https://wordpress.org/support/theme/photoframe/" target="_blank">
                        <span class="dashicons dashicons-sos">
                        </span>
                        '.esc_html__( 'Support Forum', 'photoframe' ).'
                    </a>
                    <a class="bnt-customizer-link bnt-rate-link" href="https://wordpress.org/support/theme/photoframe/reviews/" target="_blank">
                        <span class="dashicons dashicons-heart">
                        </span>
                        '.esc_html__( 'Rate Podcast', 'photoframe' ).'
                    </a>
                </div>
            ';
        }
        ...
        $wp_customize->add_section( 
            'photoframe_theme_support', 
            array(
                'title' => esc_html__( 'Theme Help & Support', 'photoframe' ),
                'priority' => 19,
            ) 
        );
        ...
        $wp_customize->add_control(
            ...
            'photoframe_support', 
                array(
                    'section' => 'photoframe_theme_support',
                    'type' => 'text_help',
                )
            )
        );
