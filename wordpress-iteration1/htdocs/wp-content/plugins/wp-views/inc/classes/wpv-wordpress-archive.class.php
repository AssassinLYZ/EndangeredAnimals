...
final class WPV_WordPress_Archive extends WPV_WordPress_Archive_Embedded {
    ...
    public static function create( $title, $args ) {
	    ...
	    $wpa_id = WPV_View_Base::create_post( $title, $args );
	...
	/**
	 * Returns true if the WordPress Archive was created in the block editor.
	 *
	 * @return bool
	 */
	public function get_is_gutenberg_wpa() {
		$maybe_gutenberg_wpa = $this->get_postmeta( '_wpv_view_data' );
		return ! empty( $maybe_gutenberg_wpa );
	}
}
