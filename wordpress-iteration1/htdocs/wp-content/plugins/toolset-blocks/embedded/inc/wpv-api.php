...
*/
function get_view_query_results( $view_id, $post_in = null, $current_user_in = null, $args = array(), $post_status_allowed = 'publish' ) {
...
function render_view( $args, $get_override = array() ) {
	...
	if (
		...
		if ( isset( $args['target_id'] ) ) {
			$out = $WP_Views->short_tag_wpv_view_form( $args );
		} else {
