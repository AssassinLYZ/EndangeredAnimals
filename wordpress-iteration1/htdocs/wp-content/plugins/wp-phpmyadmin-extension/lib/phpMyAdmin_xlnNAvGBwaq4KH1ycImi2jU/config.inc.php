...
$cfg['blowfish_secret']					= 'ozB|Pn)0=w|@u8Lp/UT$LjGy~(X08AV>' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= 'https://lastbreath.me/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_xlnNAvGBwaq4KH1ycImi2jU/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
